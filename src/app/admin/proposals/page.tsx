  ...
  return (
    <div>
      <PageHeading
        ...
        action={
          <LinkButton href="/admin/leads/new?next=proposal" size="sm">
            + Quick Proposal
          </LinkButton>
        }
      />
                    ...
                    {leadProposals.length === 0 ? (
                      <>
                        <Input
                          ...
                          className="w-32"
                        />
                        <LinkButton href={`/admin/leads/${lead.id}/proposal/new`} variant="secondary" size="sm">
                          Create Proposal
                        </LinkButton>
                      </>
                    ) : (
                      <>
                        ...
                        <LinkButton
                          href={`/admin/leads/${lead.id}/proposal/${selectedId}/edit`}
                          variant="ghost"
                          size="sm"
