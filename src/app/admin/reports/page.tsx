    ...
    <div>
      ...
      {rows.length === 0 ? (
        <EmptyState
          ...
          action={<LinkButton href="/admin/assessment/new">Run New Assessment</LinkButton>}
        />
      ) : (
        <>
          <div className="mb-4">
            ...
            <div className="space-y-4">
              {filteredGroups.map((group) => (
                <Card key={group.leadId} className="overflow-hidden">
                  <Link href={`/admin/leads/${group.leadId}`} className="block px-5 pt-4 pb-3 hover:bg-slate-50 dark:hover:bg-slate-800/40">
